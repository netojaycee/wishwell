...
export default function AboutPage() {
  return (
    <div className="mx-auto max-w-2xl px-6 py-16">
      <h1 className="font-heading text-3xl">About Wishwell</h1>
      <p className="mt-5 leading-relaxed text-black/75">
        Wishwell exists because the two products that already do this well have picked
        ...
        either box. Wishwell is built to hold all of them: birthdays, farewells, weddings,
      ...
      <p className="mt-4 leading-relaxed text-black/75">
        ...
        Wishwell is built and run by a solo founder in Nigeria. If you have a question,
